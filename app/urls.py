...
urlpatterns = [
  ...
  path("react/<int:status_id>/<str:reaction_type>/", views_newsfeed.react_to_status, name="react_to_status"),
  ...
  path('accounts/profile/<int:profile_id>/settings', views_profile.profile_settings, name='profile_settings'),
]
