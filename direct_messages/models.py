...
class Conversation(models.Model):
    ...
    last_message = models.ForeignKey(
        ...
        related_name="last_in_conversation",
    )
...
class ConversationStatus(models.Model):
    conversation = models.ForeignKey(
        Conversation, on_delete=models.CASCADE, related_name="statuses"
    )
    profile = models.ForeignKey(
        Profile, on_delete=models.CASCADE, related_name="conversation_statuses"
    )
